...
return}throw "Unable to print message: " + String(a)}}],["","file:///C:/Users/luis%20angel/one-hour-codelab-master/web/1-blankbadge/piratebadge.dart",,A,{
"":"",
...
H.VM(new W.xC(0,x.uv,x.Ph,W.VF(A.qC()),x.Sg),[H.Kp(x,0)]).Zz()
x=document.querySelector("#inputName")
x.toString
y=H.VM(new W.Cq(x,y,!1),[null])
...
z=J.RE(a)
document.querySelector("#badgeName").textContent=H.Go(z.gN(a),"$isMi").value
y=H.Go(z.gN(a),"$isMi").value
z=J.Q7(y)
x=$.Tn
if(z.length===0){J.lo(x,!1)
x.textContent="Aye! Gimme a name!"}else{J.lo(x,!0)
x.textContent="Arrr! Write yer name!"}A.Qx(A.ly(null,y))},"call$1","qC",2,0,9],
Qx:function(a){var z
if(a==null)return
